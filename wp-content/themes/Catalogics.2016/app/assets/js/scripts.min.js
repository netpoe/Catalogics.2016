...
!function(a, b) {
    ...
    "function" == typeof define && define.amd ? define([ "ScrollMagic", "jquery" ], b) : "object" == typeof exports ? b(require("scrollmagic"), require("jquery")) : b(a.ScrollMagic, a.jQuery);
}(this, function(a, b) {
    "use strict";
    a._util.get.elements = function(a) {
        return b(a).toArray();
    }, a._util.addClass = function(a, c) {
        b(a).addClass(c);
    }, a._util.removeClass = function(a, c) {
        b(a).removeClass(c);
    }, b.ScrollMagic = a;
}), function() {
    $(document).ready(function() {
        var a, b;
        a = $(".services-block"), b = new ScrollMagic.Controller(), $.each(a, function(a, c) {
            var d, e;
            e = ".section-scroll-" + a, $(c).addClass("section-scroll-" + a), d = new ScrollMagic.Scene({
                triggerHook: "onLeave",
                triggerElement: e,
                duration: $(c).height()
            }).setClassToggle(e, "animate").addTo(b);
        });
    });
}.call(this), function() {
    $(document).ready(function() {
